...
static int GlogLevelToPmLogLevel(int glib_level)
{
    ...
    {
        case G_LOG_LEVEL_ERROR:  return kPmLogLevel_Alert;
        case G_LOG_LEVEL_CRITICAL: return kPmLogLevel_Critical;
        case G_LOG_LEVEL_WARNING: return kPmLogLevel_Warning;
        case G_LOG_LEVEL_MESSAGE: return kPmLogLevel_Notice;
        case G_LOG_LEVEL_INFO:  return kPmLogLevel_Info;
        case G_LOG_LEVEL_DEBUG:  return kPmLogLevel_Debug;
    }
