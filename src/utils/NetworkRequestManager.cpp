...
ErrorCodes NetworkRequestManager::initiateTransaction(const char **headers, int size, string url, bool isSync, LSMessage *message, HttpInterface*userdata)
{
    ...
    LS_LOG_DEBUG("initiate_Transaction succesful gHttpReqTask address %p", gHttpReqTask);
